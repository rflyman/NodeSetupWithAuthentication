This is a base install with authentication that can be used for future projects. It implements Node.js, express, angular 2, bootstrap, mongodb, angular-jwt, and EJS templates.<br />
<br />
Configuration:<br />
